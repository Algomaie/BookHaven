    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                ...
                <p>Your one-stop destination for all types of books. Browse our collection and find your next favorite read.</p>
            </div>
            <div class="col-md-4">
                <h5>Quick Links</h5>
            ...
            <div class="col-md-4">
                ...
                <address>
                    ...
                    <i class="fas fa-envelope me-2"></i> info@bookhaven.com
                </address>
